...
export class _Tokenizer {
  ...
  emStrong(src: string, maskedSrc: string, prevChar = ''): Tokens.Em | Tokens.Strong | undefined {
    ...
    const re = isSupportUnicodeRegex
      // use new RegExp to avoid been transpile by @babel/plugin-transform-unicode-regex
    ...
    if (match[3] && prevChar.match(re)) return;
